 ...
 ## Gathers preliminary info and loops it for each computer ##
    ...
    foreach ($Computer in $ComputerName){
        ...
        ## Invokes gathering Hardware Information ##
           $bios = Get-WmiObject Win32_ComputerSystemProduct -ComputerName $Computer  | Select Vendor,Version,Name,IdentifyingNumber,UUID
                    ...
                    $Obj = New-Object psobject -Property @{
                        ...
                        'Name' = $bios.Name
                        'IdentifyingNumber' = $bios.IdentifyingNumber
                        'UUID' = $bios.UUID
                          }
                        $Objs += $Obj
                    }            
...
## Selects Object 
$objs | Select-Object ComputerID, Vendor, Version, Name, IdentifyingNumber, UUID
...
$logdsk = $Objs | select ComputerID, Vendor, Version, Name, IdentifyingNumber, UUID
