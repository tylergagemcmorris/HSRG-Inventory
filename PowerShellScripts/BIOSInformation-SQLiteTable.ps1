 ...
 ## Gathers preliminary info and loops it for each computer ##
    ...
    foreach ($Computer in $ComputerName){
        ...
        ## Invokes gathering Hardware Information ##
            $bios = Get-WmiObject win32_bios -ComputerName $Computer  | Select Manufacturer,Name,BIOSVersion,PrimaryBIOS,ReleaseDate,SMBIOSBIOSVersion,SMBIOSMajorVersion,SMBIOSMinorVersion
 	       
                    $Obj = New-Object psobject -Property @{
                        'ComputerID' = $Computer
                        'Manufacturer' = $bios.Manufacturer
                        'Name' = $bios.Name
                        'BIOSVersion' = $bios.BIOSVersion | Out-String 
...
## Selects Object 
$objs | Select-Object ComputerID, Manufacturer,Name,BIOSVersion,PrimaryBIOS,ReleaseDate,SMBIOSBIOSVersion,SMBIOSMajorVersion,SMBIOSMinorVersion
...
#$Query = "CREATE TABLE BIOSInformation (ComputerID TEXT PRIMARY KEY, Manufacturer TEXT, Name TEXT, BIOSVersion TEXT, PrimaryBIOS TEXT, ReleaseDate TEXT ,SMBIOSBIOSVersion TEXT, SMBIOSMajorVersion INTEGER, SMBIOSMinorVersion INTEGER)"
#Invoke-SqliteQuery -DataSource $DataSource -Query $Query 


## Takes items pulled from object created and outputs them to datatable ##
$logdsk = $Objs | select ComputerID, Manufacturer,Name,BIOSVersion,PrimaryBIOS,ReleaseDate,SMBIOSBIOSVersion,SMBIOSMajorVersion,SMBIOSMinorVersion
